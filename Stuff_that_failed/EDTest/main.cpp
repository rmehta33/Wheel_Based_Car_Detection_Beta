...
#pragma comment(lib, "EDLib.lib")          // DetectEdgesByED, DetectEdgesByEDPF functions
...
int main(){
  ...
  SaveImagePGM("ED-EdgeMap.pgm", (char *)map->edgeImg, width, height);
  delete map;
  ...
  SaveImagePGM("EDPF-EdgeMap.pgm", (char *)map->edgeImg, width, height);
  delete map;
